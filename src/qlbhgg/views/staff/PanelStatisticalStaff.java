 ...
 * @author acer
 */
public class PanelStatisticalStaff extends javax.swing.JPanel {
    ...
    public float totalRevenueOfAll = 0;
    public int staffActive = UsersDao.countStaffActive();
    public int staffBlock = UsersDao.countStaffBlock();
    public int totalStaff = staffActive + staffBlock;
    public int totalProductWearHouse = GoodsDao.countProductWearHouse();
    ...
    public PanelStatisticalStaff(String u) throws SQLException {
        initComponents();
        this.userLogin = u;
        statingState();
    }
    ...
    public void datasetPeriod() throws SQLException {
        totalBill = BillDao.countTotalBillByPeriodForStaff(fromDate, toDate, userLogin);
        totalRevenue = InvoicedetailsDao.countTotalRevenueByPeriodForStaff(fromDate, toDate, userLogin);
        totalRevenueOfAll = InvoicedetailsDao.countTotalRevenueByPeriodAll(fromDate, toDate, userLogin);
    ...
    public void actionDatasetExactDay(boolean m, boolean d) throws SQLException {
        totalBill = BillDao.countTotalBillByDateForStaff(String.valueOf(selectedYear), String.valueOf(selectedMonth), String.valueOf(selectedDay), m, d, userLogin);
        totalRevenue = InvoicedetailsDao.countTotalRevenueByDateForStaff(String.valueOf(selectedYear), String.valueOf(selectedMonth), String.valueOf(selectedDay), m, d, userLogin);
        totalRevenueOfAll = InvoicedetailsDao.countTotalRevenueByDateAll(String.valueOf(selectedYear), String.valueOf(selectedMonth), String.valueOf(selectedDay), m, d, userLogin);
    ...
    public void createPie3DChart() {
        DefaultPieDataset dataset = new DefaultPieDataset();
        
            dataset.setValue("Tôi", totalRevenue);
            dataset.setValue("Còn lại", totalRevenueOfAll);
...
//        plot.setForegroundAlpha(0.6f);
    ...
    private void initComponents() {
        ...
        jDashboardTK.add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 0, 460, 270));

        jPanel3.setBackground(new java.awt.Color(255, 255, 255));
        jPanel3.setLayout(new java.awt.BorderLayout());
        jDashboardTK.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 280, 1320, 300));
        ...
        jPanel5.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(23, 10, 300, -1));
        ...
        jPanel5.add(jLabelTotalRevenue, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 330, 200));
        ...
        jPanel4.add(jLabelTotalBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 470, 110));
        ...
        jPanel4.add(jLabel15, new org.netbeans.lib.awtextra.AbsoluteConstraints(5, 10, 480, -1));

        jDashboardTK.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, 490, 160));
    ...
    private void jLabelAddDayMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelAddDayMouseClicked
        ...
        try {
            ...
            Logger.getLogger(PanelStatisticalStaff.class.getName()).log(Level.SEVERE, null, ex);
        }
