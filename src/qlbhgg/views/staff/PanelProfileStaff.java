...
public class PanelProfileStaff extends javax.swing.JPanel {
    ...
    public void showCalendar() throws SQLException {
        ...
        float totalRevenue = InvoicedetailsDao.totalRevenueByStaff(String.valueOf(selectedYear), String.valueOf(selectedMonth + 1), userLogin.getId());
        jLabelNumberOfStatistical.setText("- Doanh số: " + String.format("%1$,.0f" + " VNĐ", totalRevenue));
        jLabelNumberOfSalary.setText("- Lương: " + String.format("%1$,.0f" + " VNĐ", numberOfWorking * userLogin.getBasicsalary() / 28 + totalRevenue * 0.05 + userLogin.getAllowance()));
