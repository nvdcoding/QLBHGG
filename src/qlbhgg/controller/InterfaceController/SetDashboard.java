...
import qlbhgg.views.staff.PanelStatisticalStaff;
...
public class SetDashboard {
    ...
    public void setStaffView(JPanel jpItem, JLabel jlItem, Users u) throws SQLException {
        kindSelected = "QLBH";
        jpItem.setBackground(new Color(102, 178, 255));
        jlItem.setBackground(new Color(102, 178, 255));
        this.userLogin = u;
    ...
    class PanelEvent implements MouseListener {
        ...
        public void mouseClicked(MouseEvent e) {
            switch (kind) {
                ...
                case "TKADMIN": {
                    try {
                        node = new PanelStatisticalAdmin();
                    } catch (SQLException ex) {
                        Logger.getLogger(SetDashboard.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
                ...
                case "TKSTAFF": {
                    try {
                        node = new PanelStatisticalStaff(userLogin.getId());
                    } catch (SQLException ex) {
                        Logger.getLogger(SetDashboard.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
