...
import qlbhgg.dao.GetNextCodeDao;
...
public class PanelSale extends javax.swing.JPanel {
    ...
    public ArrayList<Users> ListUsers = UsersDao.findStaffActive();
    ...
    public float totalPrice = 0, totalDiscount = 0, moreDiscount = 0;
    ...
    public PanelSale() throws SQLException {
        ...
        for (Users u : ListUsers) {
            jComboBoxStaff.addItem(u.getFullname());
        }
        for (Customers c : ListCustomers) {
            jComboBoxCustomer.addItem(c.getCustomername());
        }
    ...
    private void showProductsBill(ArrayList<Invoicedetails> ListBill, int countProductBill) throws SQLException {
        ...
        codeBill = GetNextCodeDao.getBillCode();
        jLabelBillcode.setText(codeBill);
        if (ListBill.size() > 0) {
            ...
            if (pageBill + 7 < countProductBill) {
                renderJPanelBill(pageBill + 8, ListBill.get(pageBill + 7), jPanelRowBill8, jLabelNumOrder8, jLabelImage8, jLabelName8, jLabelTotalPrice8, jTextFieldPrice8, jTextFieldAmount8, jTextFieldDiscount8);
            } else {
                jPanelRowBill8.setVisible(false);
            }
            totalPrice = 0;
            ...
            moreDiscount = Float.parseFloat(jTextFieldMoreDiscount.getText().replace(",", ""));
            jLabelCustomerNeedPay.setText(String.format("%1$,.0f", totalPrice - totalDiscount - moreDiscount));
            jTextFieldMoreDiscount.setText(String.format("%1$,.0f", Float.parseFloat(jTextFieldMoreDiscount.getText().replace(",", ""))));

            float excessCash = Float.parseFloat(jTextFieldCustomerPay.getText().replace(",", "")) - Float.parseFloat(jLabelCustomerNeedPay.getText().replace(",", ""));
            jLabelExcessCash.setText(String.format("%1$,.0f", excessCash));
            jTextFieldCustomerPay.setText(String.format("%1$,.0f", Float.parseFloat(jTextFieldCustomerPay.getText().replace(",", ""))));
        }
    }
    ...
    public ImageIcon scaleImageStaff(String path) {
        ImageIcon icon = new ImageIcon(getClass().getResource(path));
        Image img = icon.getImage();
        Image imgScale = img.getScaledInstance(90, 90, Image.SCALE_SMOOTH);
        ImageIcon scaledIcon = new ImageIcon(imgScale);
        return scaledIcon;
    }
    ...
    private void initComponents() {
        ...
        jLabelBillcode = new javax.swing.JLabel();
        ...
        jLabelImageStaff = new javax.swing.JLabel();
        jLabelEmailCustomer = new javax.swing.JLabel();
        jLabelPhoneNumberCustomer = new javax.swing.JLabel();
        ...
        jTextFieldPrice8.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPrice8KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount8.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount8KeyTyped(evt);
            }
        });
        ...
        jTextFieldPrice7.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPrice7KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount7.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount7KeyTyped(evt);
            }
        });
        ...
        jTextFieldPrice6.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPrice6KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount6.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount6KeyTyped(evt);
            }
        });
        ...
        jTextFieldPrice5.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPrice5KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount5.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount5KeyTyped(evt);
            }
        });
        ...
        jTextFieldPrice4.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPrice4KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount4.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount4KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount3.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount3KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount2.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount2KeyTyped(evt);
            }
        });
        ...
        jTextFieldDiscount1.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldDiscount1KeyTyped(evt);
            }
        });
        ...
        jTextFieldPageBill2.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                jTextFieldPageBill2KeyPressed(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPageBill2KeyTyped(evt);
            }
        });
        ...
        jLabelStaff2.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        jPanelPay.add(jLabelStaff2, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 160, 100, -1));

        jLabelStaff1.setBackground(new java.awt.Color(255, 255, 255));
        jLabelStaff1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelStaff1.setText("Khách hàng:");
        jPanelPay.add(jLabelStaff1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 180, 100, -1));

        jLabelStaff.setBackground(new java.awt.Color(255, 255, 255));
        jLabelStaff.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        ...
        jTextFieldCustomerPay.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        jTextFieldCustomerPay.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldCustomerPayKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldCustomerPayKeyTyped(evt);
            }
        });
        jPanelPay.add(jTextFieldCustomerPay, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 90, 260, -1));

        jLabelTotalPriceBill.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTotalPriceBill.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabelTotalPriceBill.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabelTotalPriceBill.setText("0");
        jPanelPay.add(jLabelTotalPriceBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 110, 260, -1));

        jLabelDiscountBill1.setBackground(new java.awt.Color(255, 255, 255));
        jLabelDiscountBill1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelDiscountBill1.setText("Giảm giá thêm:");
        jPanelPay.add(jLabelDiscountBill1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 200, 120, -1));

        jLabelDiscountBill.setBackground(new java.awt.Color(255, 255, 255));
        jLabelDiscountBill.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabelDiscountBill.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jLabelDiscountBill.setText("0");
        jPanelPay.add(jLabelDiscountBill, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 170, 260, -1));

        jLabelCustomerNeedPay.setBackground(new java.awt.Color(255, 255, 255));
        jLabelCustomerNeedPay.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        jPanelPay.add(jLabelCustomerNeedPay, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 50, 260, 20));

        jLabelCustomerPay.setBackground(new java.awt.Color(255, 255, 255));
        jLabelCustomerPay.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelCustomerPay.setText("Khách thanh toán:");
        jPanelPay.add(jLabelCustomerPay, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 70, 130, -1));
        ...
        jLabelExcessCash.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        jPanelPay.add(jLabelExcessCash, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 140, 260, -1));

        jTextFieldNote.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jTextFieldNote.setBorder(null);
        jPanelPay.add(jTextFieldNote, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 180, 260, 30));

        jLabelBillcode.setBackground(new java.awt.Color(255, 255, 255));
        jLabelBillcode.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jLabelBillcode.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        jPanelPay.add(jLabelBillcode, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 30, 150, 20));
        ...
        jLabelMessage.setText("Thông báo");
        jPanelPay.add(jLabelMessage, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 220, 260, -1));

        jLabelDiscountBill2.setBackground(new java.awt.Color(255, 255, 255));
        jLabelDiscountBill2.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelDiscountBill2.setText("Tổng chiết khấu:");
        jPanelPay.add(jLabelDiscountBill2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 140, 130, -1));

        jTextFieldMoreDiscount.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        ...
        jTextFieldMoreDiscount.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldMoreDiscountKeyReleased(evt);
            }
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldMoreDiscountKeyTyped(evt);
            }
        });
        jPanelPay.add(jTextFieldMoreDiscount, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 230, 260, -1));

        jLabelCustomerNeedPay1.setBackground(new java.awt.Color(255, 255, 255));
        jLabelCustomerNeedPay1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelCustomerNeedPay1.setText("Khách cần trả:");
        jPanelPay.add(jLabelCustomerNeedPay1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 30, 110, -1));

        jLabelExcessCash1.setBackground(new java.awt.Color(255, 255, 255));
        jLabelExcessCash1.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelExcessCash1.setText("Tiền thừa:");
        jPanelPay.add(jLabelExcessCash1, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 120, 100, -1));
        jPanelPay.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 250, 260, 10));
        jPanelPay.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 210, 260, 10));
        jPanelPay.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 110, 260, 10));
        ...
        jLabelAdd.setText("Lưu");
        jLabelAdd.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        jPanelPay.add(jLabelAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, 150, 50));
        ...
        jPanelPay.add(jLabelButtonAdd, new org.netbeans.lib.awtextra.AbsoluteConstraints(610, 250, 150, 50));

        jComboBoxCustomer.setEditable(true);
        jComboBoxCustomer.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jComboBoxCustomer.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Chọn khách hàng  --" }));
        jComboBoxCustomer.setBorder(null);
        jComboBoxCustomer.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jComboBoxCustomer.setDoubleBuffered(true);
        jComboBoxCustomer.setFocusable(false);
        jComboBoxCustomer.setName(""); // NOI18N
        jComboBoxCustomer.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxCustomerActionPerformed(evt);
            }
        });
        jPanelPay.add(jComboBoxCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 200, 200, 30));

        jComboBoxStaff.setEditable(true);
        jComboBoxStaff.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jComboBoxStaff.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "-- Chọn nhân viên --" }));
        jComboBoxStaff.setBorder(null);
        jComboBoxStaff.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jComboBoxStaff.setDoubleBuffered(true);
        jComboBoxStaff.setFocusable(false);
        jComboBoxStaff.setName(""); // NOI18N
        jComboBoxStaff.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jComboBoxStaffActionPerformed(evt);
            }
        });
        jPanelPay.add(jComboBoxStaff, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 50, 200, 30));
        jPanelPay.add(jLabelImageStaff, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 90, 90));

        jLabelEmailCustomer.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jPanelPay.add(jLabelEmailCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 270, 220, 30));

        jLabelPhoneNumberCustomer.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelPhoneNumberCustomer.setForeground(new java.awt.Color(102, 178, 255));
        jPanelPay.add(jLabelPhoneNumberCustomer, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 240, 220, 30));

        jLabelTotalPriceBill2.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTotalPriceBill2.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelTotalPriceBill2.setText("Tổng tiền hàng:");
        jPanelPay.add(jLabelTotalPriceBill2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 80, 120, -1));

        jLabelTotalPriceBill3.setBackground(new java.awt.Color(255, 255, 255));
        jLabelTotalPriceBill3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabelTotalPriceBill3.setText("Mã đơn hàng:");
        jPanelPay.add(jLabelTotalPriceBill3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, 100, -1));
        ...
        jTextFieldPageBill1.addKeyListener(new java.awt.event.KeyAdapter() {
            ...
            public void keyTyped(java.awt.event.KeyEvent evt) {
                jTextFieldPageBill1KeyTyped(evt);
            }
        });
        ...
        jLabelOver12.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct12.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver11.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct11.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver10.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct10.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver9.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct9.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver8.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct8.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver7.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct7.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver6.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct6.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver5.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver4.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct4.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver3.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct3.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver2.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        jLabelOver1.setForeground(new java.awt.Color(255, 255, 255));
        jLabelOver1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/qlbhgg/ImagePng/soldOutRed.png"))); // NOI18N
        ...
        jLabelNameProduct1.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
    ...
    private void jTextFieldDiscount1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount1.getText().equals("")){
                jTextFieldDiscount1.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount1.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount1.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount1.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount2KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount2.getText().equals("")){
                jTextFieldDiscount2.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount2.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount2.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount2.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount3KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount3.getText().equals("")){
                jTextFieldDiscount3.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount3.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount3.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount3.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount4KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount4.getText().equals("")){
                jTextFieldDiscount4.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount4.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount4.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount4.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount5KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount5.getText().equals("")){
                jTextFieldDiscount5.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount5.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount5.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount5.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount6KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount6.getText().equals("")){
                jTextFieldDiscount6.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount6.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount6.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount6.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount7KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount7.getText().equals("")){
                jTextFieldDiscount7.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount7.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount7.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount7.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldDiscount8KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount8KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldDiscount8.getText().equals("")){
                jTextFieldDiscount8.setText(String.valueOf(0));
            }
            int dc = Integer.parseInt(jTextFieldDiscount8.getText());
            if (dc < 0) {
                dc = 0;
                jTextFieldDiscount8.setText(String.valueOf(dc));
            } else if (dc > 100) {
                dc = 100;
                jTextFieldDiscount8.setText(String.valueOf(dc));
            }
    ...
    private void jTextFieldAmount1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount1.getText().equals("")){
                jTextFieldAmount1.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount2KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount2.getText().equals("")){
                jTextFieldAmount2.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount3KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount3KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount3.getText().equals("")){
                jTextFieldAmount3.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount4KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount4KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount4.getText().equals("")){
                jTextFieldAmount4.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount5KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount5KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount5.getText().equals("")){
                jTextFieldAmount5.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount6KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount6KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount6.getText().equals("")){
                jTextFieldAmount6.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount7KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount7KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount7.getText().equals("")){
                jTextFieldAmount7.setText(String.valueOf(1));
            }
    ...
    private void jTextFieldAmount8KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount8KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if(jTextFieldAmount8.getText().equals("")){
                jTextFieldAmount8.setText(String.valueOf(1));
            }
    ...
    private void jLabelButtonAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabelButtonAddMouseClicked
        if (jComboBoxStaff.getSelectedIndex() == 0 || jComboBoxCustomer.getSelectedIndex() == 0 || ListBill1.size() == 0) {
            jLabelMessage.setText("Bạn chưa điền đủ thông tin!");
            jLabelMessage.setForeground(new java.awt.Color(255, 0, 0));
            jLabelMessage.setVisible(true);
        } else {
            Bill b = new Bill();
            b.setCodebill(codeBill);
            b.setCustomercode(ListCustomers.get(jComboBoxCustomer.getSelectedIndex() - 1).getCustomercode());
            b.setIduser(ListUsers.get(jComboBoxStaff.getSelectedIndex() - 1).getId());
            java.util.Date now = new java.util.Date();
            b.setCreationdate(now);
            b.setNote(jTextFieldNote.getText());
            BillDao.addBill(b);
            for (Invoicedetails i : ListBill1) {
                i.setCodebill(codeBill);
                InvoicedetailsDao.addInvoicedetails(i);
                GoodsDao.minusGood(i.getAmount(), i.getItemcode());
            }
            GetNextCodeDao.updateCodeBill();
            jLabelMessage.setText("Thêm hóa đơn thành công!");
            jLabelMessage.setForeground(new java.awt.Color(0, 255, 0));
            jLabelMessage.setVisible(true);

            ListBill1.clear();
            countProductBill = ListBill1.size();
            try {
                countProductSale = GoodsDao.countProduct();
                ListGoodsSale = GoodsDao.findAll();
                showProductsSale(ListGoodsSale, countProductSale);
                showProductsBill(ListBill1, countProductBill);
                jComboBoxStaff.setSelectedIndex(0);
    ...
    private void jComboBoxStaffActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxStaffActionPerformed
        if ((jComboBoxStaff.getSelectedIndex() - 1) >= 0) {
            Users u = ListUsers.get(jComboBoxStaff.getSelectedIndex() - 1);
            jLabelImageStaff.setIcon(scaleImageStaff(u.getImage_user()));
        } else {
            jLabelImageStaff.setIcon(null);
        }
    ...
    private void jComboBoxCustomerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxCustomerActionPerformed
        if ((jComboBoxCustomer.getSelectedIndex() - 1) >= 0) {
            Customers c = ListCustomers.get(jComboBoxCustomer.getSelectedIndex() - 1);
            jLabelPhoneNumberCustomer.setText(c.getPhonenumber());
            jLabelEmailCustomer.setText(c.getEmail());
        } else {
            jLabelPhoneNumberCustomer.setText("");
            jLabelEmailCustomer.setText("");
        }
    }//GEN-LAST:event_jComboBoxCustomerActionPerformed

    private void jTextFieldCustomerPayKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCustomerPayKeyReleased
        if (jTextFieldCustomerPay.getText().equals("")) {
            jTextFieldCustomerPay.setText("0");
        }
        float excessCash = Float.parseFloat(jTextFieldCustomerPay.getText().replace(",", "")) - Float.parseFloat(jLabelCustomerNeedPay.getText().replace(",", ""));
        jLabelExcessCash.setText(String.format("%1$,.0f", excessCash));
        jTextFieldCustomerPay.setText(String.format("%1$,.0f", Float.parseFloat(jTextFieldCustomerPay.getText().replace(",", ""))));
    }//GEN-LAST:event_jTextFieldCustomerPayKeyReleased

    private void jTextFieldPageBill1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPageBill1KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_jTextFieldPageBill1KeyTyped
    ...
    private void jTextFieldPrice2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice2KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldPrice2KeyTyped

    private void jTextFieldPrice3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice3KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldPrice3KeyTyped

    private void jTextFieldPrice4KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice4KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldPrice4KeyTyped

    private void jTextFieldPrice5KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice5KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldPrice5KeyTyped

    private void jTextFieldPrice6KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice6KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldPrice6KeyTyped

    private void jTextFieldPrice7KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice7KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldPrice7KeyTyped

    private void jTextFieldPrice8KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPrice8KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_jTextFieldPrice8KeyTyped
    ...
    private void jTextFieldAmount2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount2KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount2KeyTyped

    private void jTextFieldAmount3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount3KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount3KeyTyped

    private void jTextFieldAmount4KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount4KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount4KeyTyped

    private void jTextFieldAmount5KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount5KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount5KeyTyped

    private void jTextFieldAmount6KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount6KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount6KeyTyped

    private void jTextFieldAmount7KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount7KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount7KeyTyped

    private void jTextFieldAmount8KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldAmount8KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldAmount8KeyTyped

    private void jTextFieldDiscount1KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount1KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount1KeyTyped

    private void jTextFieldDiscount2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount2KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount2KeyTyped

    private void jTextFieldDiscount3KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount3KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount3KeyTyped

    private void jTextFieldDiscount4KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount4KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount4KeyTyped

    private void jTextFieldDiscount5KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount5KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount5KeyTyped

    private void jTextFieldDiscount6KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount6KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount6KeyTyped

    private void jTextFieldDiscount7KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount7KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount7KeyTyped

    private void jTextFieldDiscount8KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldDiscount8KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldDiscount8KeyTyped

    private void jTextFieldMoreDiscountKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldMoreDiscountKeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldMoreDiscountKeyTyped

    private void jTextFieldCustomerPayKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldCustomerPayKeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }    }//GEN-LAST:event_jTextFieldCustomerPayKeyTyped

    private void jTextFieldMoreDiscountKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldMoreDiscountKeyReleased
        if (jTextFieldMoreDiscount.getText().equals("")) {
            jTextFieldMoreDiscount.setText("0");
        }
        float moreDiscount = Float.parseFloat(jTextFieldMoreDiscount.getText().replace(",", ""));
        jLabelCustomerNeedPay.setText(String.format("%1$,.0f", totalPrice - totalDiscount - moreDiscount));
        jTextFieldMoreDiscount.setText(String.format("%1$,.0f", Float.parseFloat(jTextFieldMoreDiscount.getText().replace(",", ""))));
    }//GEN-LAST:event_jTextFieldMoreDiscountKeyReleased

    private void jTextFieldPageBill2KeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPageBill2KeyTyped
        if (!Character.isDigit(evt.getKeyChar())) {
            evt.consume();
        }
    }//GEN-LAST:event_jTextFieldPageBill2KeyTyped

    private void jTextFieldPageBill1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPageBill1KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (Integer.parseInt(jTextFieldPageBill1.getText()) > countProductSale / 12 + setPageProductSale) {
                jTextFieldPageBill1.setText(String.valueOf(countProductSale / 12 + setPageProductSale));
            } else if (Integer.parseInt(jTextFieldPageBill1.getText()) < 1) {
                jTextFieldPageBill1.setText("1");
            }
            try {
                showProductsSale(ListGoodsSale, countProductSale);
    ...
    private void jTextFieldPageBill2KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldPageBill2KeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (Integer.parseInt(jTextFieldPageBill2.getText()) > countProductBill / 8 + setPageBill) {
                jTextFieldPageBill2.setText(String.valueOf(countProductBill / 8 + setPageBill));
            } else if (Integer.parseInt(jTextFieldPageBill2.getText()) < 1) {
                jTextFieldPageBill2.setText("1");
            }
            try {
                showProductsBill(ListBill1, countProductBill);
    ...
    }//GEN-LAST:event_jTextFieldPageBill2KeyPressed
    ...
    private javax.swing.JLabel jLabelBillcode;
    ...
    private javax.swing.JLabel jLabelEmailCustomer;
    ...
    private javax.swing.JLabel jLabelImageStaff;
    ...
    private javax.swing.JLabel jLabelPhoneNumberCustomer;
