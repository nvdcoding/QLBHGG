...
public class ForgotPassword extends javax.swing.JFrame {
    ...
    private void enterUsername() {
        if (!jTextFieldUsername.getText().equals("")) {
            if (checkButton) {
                try {
                    ...
                    if (ListUser.size() == 0) {
                        ...
                        pincode = qlbhgg.controller.mailhandle.MailHandle.SendPincode(ListUser.get(0).getEmail(), "Lấy lại mật khẩu đăng nhập KMA-Gear");
                ...
                if (!jTextFieldUsername.getText().equals(String.valueOf(pincode)) || jTextFieldUsername.getText().equals("")) {
        ...
        } else if (jTextFieldUsername.getText().equals("") && checkButton){
            jLabel2.setForeground(new java.awt.Color(255, 0, 0));
            ...
            jLabel2.setForeground(new java.awt.Color(255, 0, 0));
            jLabel2.setText("Bạn chưa nhập mã xác minh");
            jLabel2.setVisible(true);
            jButtonSendcode.setVisible(true);
        }
    }
    ...
    private void initComponents() {
        ...
        jButtonSendcode.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jButtonSendcodeMouseClicked(evt);
            }
            public void mouseEntered(java.awt.event.MouseEvent evt) {
    ...
    private void jButtonSendcodeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSendcodeActionPerformed
        pincode = qlbhgg.controller.mailhandle.MailHandle.SendPincode(ListUser.get(0).getEmail(), "Quên mật khẩu đăng nhập KMA-Gear");
    ...
    private void jButtonSendcodeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButtonSendcodeMouseClicked
        // TODO add your handling code here:
    }//GEN-LAST:event_jButtonSendcodeMouseClicked
